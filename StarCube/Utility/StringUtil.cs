...
namespace StarCube.Utility
{
    ...
    {
        private static readonly ThreadLocal<StringBuilder> stringBuilder = new ThreadLocal<StringBuilder>(() => new StringBuilder(64));

        /// <summary>
        /// 获取一个 ThreadLocal 的全局静态空 StringBuilder，
        /// 警告 : 不要在使用完毕此 StringBuilder 之前调用其他使用此属性的方法
        /// </summary>
        public static StringBuilder StringBuilder => stringBuilder.Value.Clear();
